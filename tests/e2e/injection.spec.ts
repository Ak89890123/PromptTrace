...
test('content script injects shadow UI without a page frame container on an http page', async ({ context }) => {
  ...
  // The retired page-frame feature must not append a container to <html>.
